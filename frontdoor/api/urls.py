...
router.register(r'lease/(?P<lease_id>.+)/users', views.LeaseUserViewSetById)
router.register(r'rooms', views.LeaseRoomViewSet)
router.register(r'lease/(?P<lease_id>.+)/rooms', views.LeaseRoomViewSetById)
...
urlpatterns = [
    ...
    path('switchtohouse/<int:house_id>/', views.switchtohouse, name='switchtohouse'),
